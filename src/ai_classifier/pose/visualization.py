"""Utilities for rendering pose keypoints over source videos."""
...
def draw_pose(
    ...
    *,
    ...
    """Draw one COCO-17 pose over a video frame in place."""
...
def render_pose_video(
    ...
    *,
    ...
    keypoints = np.asarray(np.load(pose_path)["keypoints"], dtype=np.float32)
    ...
    temporary_path = output_path.with_name(f".{output_path.stem}.mp4v{output_path.suffix}")
