...
$outputDir = Join-Path $repoRoot "work_dirs\r2plus1d18_rgb_v2_16x160_head_pilot"
$arguments = @(
    ...
    "--frames", "16", "--crop-size", "160", "--crop-hitter", "--crop-padding", "0.55",
    ...
    "--batch-size", "4", "--workers", "0", "--freeze-backbone",
    "--learning-rate", "1e-5", "--side-loss-weight", "1.0",
    "--reset-optimizer", "--amp"
)
